...
- **Módulo:** api
- **Lee (6):** attendance, hr_absence_requests, hr_config, hr_non_work_days, worker_managers, workers
- **Escribe (0):** —

### `api/cron/probation-report.js`

- **Módulo:** api
- **Lee (3):** organizational_areas, organizational_subareas, workers
- **Escribe (0):** —

### `assets/js/config.js`

- **Módulo:** assets
- **Lee (7):** audit_log, permissions, role_permissions, roles, system_config, user_roles, users
- **Escribe (1):** **users**

### `assets/js/sidebar.js`

- **Módulo:** assets
- **Lee (6):** permissions, role_permissions, roles, system_announcements, user_roles, users
- **Escribe (0):** —

### `dashboard.html`

- **Módulo:** (raíz)
- **Lee (19):** budget_assignments, budget_assignments_worker_id_fkey, courses, execution_requests, grades, hr_absence_authorizations, sections, stm_prom_topics, stm_students_topics, students, support_tickets, svc_service_requests, system_config, tasks, tte_categories, tte_request_fragments, tte_requests, user_dashboard_shortcuts, workers
- **Escribe (0):** —
...
- **Módulo:** budget
- **Lee (6):** academic_years, budget_assignments, budget_categories, budget_items, system_config, workers
- **Escribe (0):** —
...
- **Módulo:** budget
- **Lee (10):** academic_years, budget_assignments, budget_items, budget_payments, budget_transfers, execution_requests, sup_suppliers, suppliers, system_config, workers
- **Escribe (0):** —

### `modules/budget/budget-queries.html`

- **Módulo:** budget
- **Lee (10):** academic_years, budget_assignments, budget_categories, budget_items, budget_payments, execution_requests, sup_suppliers, suppliers, system_config, workers
- **Escribe (0):** —

### `modules/budget/budget-request.html`

- **Módulo:** budget
- **Lee (5):** academic_years, budget_assignments, budget_items, system_config, workers
- **Escribe (0):** —
...
- **Módulo:** budget
- **Lee (10):** academic_years, budget_assignments, budget_categories, budget_items, budget_payments, budget_transfers, execution_requests, suppliers, system_config, workers
- **Escribe (0):** —
...
- **Módulo:** budget
- **Lee (2):** budget_assignments, system_config
...
- **Módulo:** budget
- **Lee (8):** budget_assignments, current_budget_year_id, execution_requests, permissions, role_permissions, roles, system_config, user_roles
- **Escribe (0):** —

### `modules/budget/initialize-budget-general.html`

- **Módulo:** budget
- **Lee (5):** academic_years, budget_assignments, budget_categories, budget_items, workers
...
- **Módulo:** config
- **Lee (7):** academic_areas, academic_subject_grades, academic_subjects, coordinator_worker_id, grades, sections, workers
- **Escribe (3):** **academic_areas**, **academic_subject_grades**, **academic_subjects**

### `modules/config/academic-assignments.html`

- **Módulo:** config
- **Lee (10):** academic_areas, academic_assignments, academic_subject_grades, academic_subjects, academic_years, courses, grades, sections, worker_job_roles, workers
...
- **Módulo:** config
- **Lee (9):** academic_areas, academic_years, courses, grades, roles, sections, student_status, students, user_roles
- **Escribe (0):** —

### `modules/config/load-test.html`

- **Módulo:** config
- **Lee (3):** test_grades, test_students, test_subjects
- **Escribe (0):** —
...
- **Módulo:** early-alerts
- **Lee (3):** early_alert_logs, families, workers
- **Escribe (1):** **tasks**
...
- **Módulo:** environmental
- **Lee (3):** env_water_alerts, env_water_meters, env_water_readings_extraordinary
...
- **Módulo:** environmental
- **Lee (7):** env_tree_care_log, env_tree_inventory, permissions, role_permissions, roles, user_roles, users
- **Escribe (0):** —
...
- **Módulo:** environmental
- **Lee (4):** academic_years, env_tree_care_log, env_tree_inventory, env_tree_species
- **Escribe (0):** —
...
- **Módulo:** environmental
- **Lee (8):** env_water_alerts, env_water_meters, env_water_readings_daily, env_water_readings_monthly, student_status, students, system_config, workers
- **Escribe (0):** —
...
- **Módulo:** environmental
- **Lee (8):** env_water_alerts, env_water_meters, env_water_readings_daily, env_water_readings_extraordinary, env_water_readings_monthly, student_status, students, workers
- **Escribe (0):** —
...
- **Módulo:** extracurricular
- **Lee (12):** academic_years, courses, fn_extracurricular_enroll, student_status, students, svc_extracurricular_activities, svc_extracurricular_activity_days, svc_extracurricular_activity_grades, svc_extracurricular_cycle_days, svc_extracurricular_cycles, svc_extracurricular_enrollment_days, svc_extracurricular_enrollments
- **Escribe (2):** **fn_extracurricular_enroll**, **svc_extracurricular_enrollments**
...
- **Módulo:** follow-ups
- **Lee (11):** courses, grades, permissions, role_permissions, roles, sections, stm_prom_topics, stm_students_topics, students, user_roles, users
- **Escribe (0):** —
...
- **Módulo:** follow-ups
- **Lee (3):** students, system_config, workers
- **Escribe (2):** **stm_docs**, **stm_students_topics**

### `modules/follow-ups/manage-group-issues.html`

- **Módulo:** follow-ups
- **Lee (9):** courses, grades, sections, stm_category, stm_docs, stm_prom_topics, stm_prom_topics_categories, tasks, workers
...
- **Módulo:** follow-ups
- **Lee (5):** roles, stm_confidential_notes, students, system_config, user_roles
- **Escribe (0):** —
...
- **Módulo:** general-tools
- **Lee (10):** attendance, courses, hr_absence_categories, hr_absence_requests, hr_non_work_days, organizational_divisions, student_status, students, system_config, workers
- **Escribe (0):** —
...
- **Módulo:** general-tools
- **Lee (4):** academic_years, indicator_categories, students, tasks
- **Escribe (0):** —
...
- **Módulo:** general-tools
- **Lee (11):** courses, familia_actividad_actividades, familia_actividad_asistencias, familia_actividad_asistencias_familiares, familia_actividad_cursos, families, family_members, grades, sections, student_status, students
...
- **Módulo:** general-tools
- **Lee (14):** cost_centers, courses, families, genders, job_roles, organizational_areas, organizational_divisions, organizational_subareas, sections, student_status, students, system_config, worker_job_roles, workers
- **Escribe (0):** —
...
- **Módulo:** general-tools
- **Lee (18):** courses, form_fields, indicator_categories, procedure_instance_steps, procedure_instances, procedure_step_branches, procedure_step_parallel_assignments, procedure_steps, procedures, project_milestones, responsible_worker_id, task_collaborators, task_deliverables, task_documents, task_progress_notes, tasks, worker_id, workers
...
- **Módulo:** hr
- **Lee (11):** cost_centers, job_roles, organizational_areas, organizational_subareas, permissions, role_permissions, roles, user_roles, users, worker_job_roles, workers
- **Escribe (0):** —
...
- **Módulo:** indicators
- **Lee (4):** indicators, kpi_relationship_suggestions, variable_values, variables
...
- **Módulo:** indicators
- **Lee (13):** academic_years, dashboard_indicators, dashboard_invitations, dashboard_variables, dashboards, indicator_goals, indicators, system_config, users, variable_goals, variable_values, variables, workers
- **Escribe (0):** —
...
- **Módulo:** indicators
- **Lee (7):** indicator_goals, indicators, kpi_improvement_plans, kpi_indicator_analysis_notes, kpi_plan_updates, tasks, users
- **Escribe (0):** —

### `modules/indicators/improvement.html`

- **Módulo:** indicators
- **Lee (4):** indicator_goals, indicators, tasks, users
...
- **Módulo:** indicators
- **Lee (11):** indicator_categories, indicator_category_assignments, indicators, segment_options, segments, survey_masters, survey_sections, users, variable_segments, variable_values, variables
...
- **Módulo:** institutional-eval
- **Lee (10):** academic_years, ie_components, ie_evaluations, ie_improvement_links, ie_management_areas, permissions, role_permissions, roles, user_roles, users
- **Escribe (0):** —
...
- **Módulo:** new-students
- **Lee (6):** academic_years, courses, grades, new_student_actors, new_students, students
...
- **Módulo:** planning
- **Lee (29):** academic_areas, academic_assignments, academic_subjects, academic_years, courses, grades, pln_comments, pln_connection_types, pln_dp_outlines, pln_ib_atl_skills, pln_ib_key_concepts, pln_ib_themes, pln_interdisc_unit_cycles, pln_interdisc_unit_disciplines, pln_interdisc_units, pln_planner_atl_skills, pln_planner_connections, pln_planner_cycles, pln_planners, pln_unit_atl_skills, pln_unit_collaborators, pln_unit_cycles, pln_unit_grades, pln_unit_key_concepts, pln_unit_subjects, pln_units, programs, users, workers
- **Escribe (0):** —
...
- **Módulo:** planning
- **Lee (17):** academic_areas, academic_assignments, academic_subjects, academic_years, courses, grades, pln_comments, pln_create_planner_cycle, pln_ib_atl_skills, pln_planner_atl_skills, pln_planner_cycles, pln_planner_dp, pln_planner_dp_components, pln_planners, programs, sections, workers
- **Escribe (7):** **pln_comments**, **pln_create_planner_cycle**, **pln_planner_atl_skills**, **pln_planner_cycles**, **pln_planner_dp**, **pln_planner_dp_components**, **pln_planners**

### `modules/planning/interdisc-unit-form.html`

- **Módulo:** planning
- **Lee (25):** academic_areas, academic_assignments, academic_subjects, academic_year_trimesters, academic_years, courses, grades, pln_comments, pln_ib_atl_skills, pln_ib_learner_profile, pln_interdisc_unit_atl_skills, pln_interdisc_unit_body, pln_interdisc_unit_concept_strategies, pln_interdisc_unit_criteria, pln_interdisc_unit_cycles, pln_interdisc_unit_disciplines, pln_interdisc_unit_learner_profile, pln_interdisc_unit_sessions, pln_interdisc_unit_tilata_attributes, pln_interdisc_units, pln_myp_concept_strategies, pln_tilata_attributes, programs, sections, workers
...
- **Módulo:** planning
- **Lee (7):** academic_assignments, academic_subjects, courses, grades, pln_dp_outlines, programs, workers
...
- **Módulo:** planning
- **Lee (9):** academic_assignments, academic_subjects, academic_years, courses, grades, pln_interdisc_unit_disciplines, pln_interdisc_units, programs, workers
...
- **Módulo:** planning
- **Lee (14):** academic_areas, academic_assignments, academic_subjects, academic_years, courses, grades, pln_ib_themes, pln_unit_collaborators, pln_unit_grades, pln_unit_subjects, pln_units, programs, sections, workers
- **Escribe (3):** **pln_unit_collaborators**, **pln_unit_grades**, **pln_units**

### `modules/planning/myp-planner-form.html`

- **Módulo:** planning
- **Lee (24):** academic_areas, academic_assignments, academic_subjects, academic_year_trimesters, academic_years, courses, grades, pln_comments, pln_ib_atl_skills, pln_ib_learner_profile, pln_myp_assessment_criteria, pln_myp_concept_strategies, pln_myp_grade_year, pln_planner_atl_skills, pln_planner_cycles, pln_planner_learner_profile, pln_planner_myp, pln_planner_myp_concept_strategies, pln_planner_tilata_attributes, pln_planners, pln_tilata_attributes, programs, sections, workers
...
- **Módulo:** planning
- **Lee (21):** academic_areas, academic_assignments, academic_subjects, academic_years, courses, grades, pln_comments, pln_connection_types, pln_create_planner_criterion, pln_create_planner_cycle, pln_ib_atl_skills, pln_planner_assessment_criteria, pln_planner_atl_skills, pln_planner_connections, pln_planner_cycles, pln_planners, pln_unit_grades, pln_units, programs, sections, workers
- **Escribe (8):** **pln_comments**, **pln_create_planner_criterion**, **pln_create_planner_cycle**, **pln_planner_assessment_criteria**, **pln_planner_atl_skills**, **pln_planner_connections**, **pln_planner_cycles**, **pln_planners**

### `modules/planning/planners.html`

- **Módulo:** planning
- **Lee (12):** academic_areas, academic_subjects, academic_years, grades, pln_comments, pln_planner_assessment_criteria, pln_planner_cycles, pln_planners, pln_units, programs, sections, workers
- **Escribe (0):** —

### `modules/planning/unit-form.html`

- **Módulo:** planning
- **Lee (34):** academic_areas, academic_assignments, academic_subjects, academic_years, courses, grades, pln_action_scope, pln_action_types, pln_comments, pln_connection_types, pln_create_unit_cycle, pln_ib_atl_skills, pln_ib_key_concepts, pln_ib_learner_profile, pln_ib_themes, pln_inquiry_stages, pln_tilata_attributes, pln_unit_action_scope, pln_unit_action_types, pln_unit_atl_skills, pln_unit_collaborators, pln_unit_cycle_connections, pln_unit_cycle_subjects, pln_unit_cycles, pln_unit_grades, pln_unit_key_concepts, pln_unit_learner_profile, pln_unit_subject_connections, pln_unit_subjects, pln_unit_tilata_attributes, pln_units, programs, sections, workers
- **Escribe (10):** **pln_comments**, **pln_create_unit_cycle**, **pln_unit_collaborators**, **pln_unit_cycle_connections**, **pln_unit_cycle_subjects**, **pln_unit_cycles**, **pln_unit_grades**, **pln_unit_subject_connections**, **pln_unit_subjects**, **pln_units**

### `modules/planning/units.html`

- **Módulo:** planning
- **Lee (13):** academic_areas, academic_subjects, academic_years, grades, pln_comments, pln_unit_collaborators, pln_unit_cycles, pln_unit_grades, pln_unit_subjects, pln_units, programs, sections, workers
- **Escribe (0):** —

### `modules/procedures/dashboard.html`

- **Módulo:** procedures
- **Lee (5):** procedure_instance_steps, procedure_instances, procedure_steps, procedures, tasks
- **Escribe (0):** —
...
- **Módulo:** procedures
- **Lee (13):** academic_areas, courses, families, field_option_catalog, form_fields, forms, genders, grades, job_roles, procedures, sections, students, workers
- **Escribe (2):** **form_responses**, **procedure_instances**

### `modules/procedures/execute-public.html`

- **Módulo:** procedures
- **Lee (18):** academic_areas, courses, families, field_option_catalog, form_fields, forms, genders, grades, job_roles, procedure_step_parallel_assignments, procedure_steps, procedures, responsible_worker_id, sections, students, system_config, worker_id, workers
- **Escribe (4):** **form_responses**, **procedure_instance_steps**, **procedure_instances**, **tasks**

### `modules/procedures/execute.html`

- **Módulo:** procedures
- **Lee (17):** academic_areas, courses, families, field_option_catalog, form_fields, forms, genders, grades, job_roles, procedure_step_parallel_assignments, procedure_steps, procedures, responsible_worker_id, sections, students, worker_id, workers
- **Escribe (4):** **form_responses**, **procedure_instance_steps**, **procedure_instances**, **tasks**
...
- **Módulo:** procedures
- **Lee (9):** field_option_catalog, form_fields, form_responses, procedure_instance_steps, procedure_instances, procedure_steps, procedures, responsible_worker_id, tasks
- **Escribe (2):** **procedure_instances**, **tasks**

### `modules/procedures/procedures.html`

- **Módulo:** procedures
- **Lee (10):** form_fields, forms, procedure_instance_steps, procedure_instances, procedure_step_branches, procedure_step_parallel_assignments, procedure_steps, responsible_worker_id, worker_id, workers
...
- **Módulo:** procedures
- **Lee (8):** field_option_catalog, form_access_workers, form_fields, form_responses, forms, procedure_instances, procedures, workers
- **Escribe (0):** —
...
- **Módulo:** profile
- **Lee (19):** academic_years, certificate_signer, certificate_template, contract_types, document_types, hr_non_work_days, job_roles, pedagogical_days, system_config, tilata_recurring_events, tilata_recurring_invitees, tilata_recurring_occurrences, user_dashboard_shortcuts, worker_certificates_log, worker_contracts, worker_job_roles, worker_managers, worker_salaries, workers
...
- **Módulo:** services
- **Lee (18):** budget_assignments, budget_categories, budget_items, svc_catering_menus, svc_internal_event_catering, svc_internal_event_services, svc_internal_event_support_staff, svc_internal_events, svc_module_config, svc_rep_trip_adults, svc_service_requests, svc_service_type_notifications, svc_sports_trip_adults, svc_support_areas, svc_transport_nodes, svc_trip_transport_nodes, system_config, workers
...
- **Módulo:** services
- **Lee (5):** svc_internal_event_services, svc_internal_events, svc_service_requests, svc_support_areas, workers
...
- **Módulo:** services
- **Lee (11):** get_workers_with_permission, svc_catering_menus, svc_internal_event_catering, svc_internal_event_services, svc_internal_events, svc_module_config, svc_service_requests, svc_service_type_notifications, svc_support_areas, users, workers
- **Escribe (5):** **get_workers_with_permission**, **svc_internal_event_catering**, **svc_internal_event_services**, **svc_internal_events**, **svc_service_requests**

### `modules/services/js/commons.js`

- **Módulo:** services
- **Lee (13):** academic_years, attendance, role_permissions, svc_catering_menus, svc_module_config, svc_student_year_services, svc_transport_destinations, svc_transport_nodes, svc_transport_rates_students, system_config, user_roles, users, workers
- **Escribe (0):** —
...
- **Módulo:** services
- **Lee (24):** calculate_transport_cost, courses, create_pedagogical_trip, execute_trip_banderazo, get_pedagogical_trip_students, get_workers_with_permission, grades, sections, student_status, students, suspend_trip, svc_catering_menus, svc_pedagogical_trip_adults, svc_pedagogical_trip_attendance, svc_pedagogical_trip_catering, svc_pedagogical_trip_grades, svc_pedagogical_trips, svc_service_requests, svc_service_type_notifications, svc_transport_nodes, svc_trip_transport_nodes, transition_trip_statuses, update_pedagogical_trip, workers
- **Escribe (8):** **calculate_transport_cost**, **create_pedagogical_trip**, **execute_trip_banderazo**, **get_workers_with_permission**, **suspend_trip**, **svc_pedagogical_trips**, **transition_trip_statuses**, **update_pedagogical_trip**
...
- **Módulo:** services
- **Lee (13):** svc_extracurricular_daily_records, svc_extracurricular_vehicle_configs, svc_internal_event_catering, svc_internal_event_services, svc_internal_events, svc_pedagogical_trips, svc_rep_trips, svc_service_requests, svc_sports_trips, svc_staff_transport_daily_records, svc_staff_transport_routes, svc_transport_destinations, workers
- **Escribe (0):** —
...
- **Módulo:** suppliers
- **Lee (8):** academic_years, permissions, role_permissions, roles, sup_legal_documents, sup_suppliers, user_roles, users
- **Escribe (0):** —

### `modules/suppliers/legal-documents.html`

- **Módulo:** suppliers
- **Lee (3):** published_by, sup_legal_document_versions, sup_legal_documents
...
- **Módulo:** suppliers
- **Lee (13):** get_workers_with_permission, sup_attachment_types, sup_banks, sup_ciiu_activities, sup_departments, sup_municipalities, sup_otp_codes, sup_supplier_attachments, sup_supplier_tax_conditions, sup_suppliers, sup_tax_conditions, sup_tax_regimes, system_config
- **Escribe (5):** **get_workers_with_permission**, **sup_otp_codes**, **sup_supplier_attachments**, **sup_supplier_tax_conditions**, **sup_suppliers**

### `modules/suppliers/register.html`

- **Módulo:** suppliers
- **Lee (14):** sup_attachment_types, sup_banks, sup_ciiu_activities, sup_departments, sup_legal_document_versions, sup_legal_documents, sup_municipalities, sup_supplier_attachments, sup_supplier_legal_acceptances, sup_supplier_tax_conditions, sup_suppliers, sup_tax_conditions, sup_tax_regimes, system_config
- **Escribe (0):** —
...
- **Módulo:** surveys
- **Lee (7):** survey_applications, survey_masters, survey_questions, survey_respondent_profile, survey_responses, survey_scales, survey_sections
- **Escribe (0):** —
...
- **Módulo:** surveys
- **Lee (9):** permissions, role_permissions, roles, survey_applications, survey_masters, survey_respondent_profile, survey_scales, user_roles, users
- **Escribe (0):** —
...
- **Módulo:** surveys
- **Lee (1):** survey_applications
- **Escribe (1):** **survey_masters**

### `modules/surveys/micro-survey-kiosk.html`

- **Módulo:** surveys
- **Lee (2):** micro_survey_responses, micro_surveys
- **Escribe (0):** —
...
- **Módulo:** teacher-eval
- **Lee (9):** academic_years, permissions, role_permissions, roles, teval_forms, teval_periods, teval_responses, user_roles, users
- **Escribe (0):** —
...
- **Módulo:** teacher-eval
- **Lee (7):** leadership_cycle_evaluatees, leadership_cycle_evaluators, leadership_cycles, leadership_dimensions, leadership_grades, leadership_interest_groups, workers
...
- **Módulo:** teacher-eval
- **Lee (11):** leadership_attributes, leadership_behaviors, leadership_cycle_evaluatees, leadership_cycle_evaluators, leadership_cycles, leadership_dimensions, leadership_interest_groups, leadership_questions, leadership_responses, worker_managers, workers
- **Escribe (0):** —
...
- **Módulo:** teacher-eval
- **Lee (13):** leadership_attributes, leadership_behaviors, leadership_cycle_evaluatees, leadership_cycle_evaluators, leadership_cycles, leadership_dimensions, leadership_improvement_actions, leadership_improvement_plans, leadership_observations, leadership_questions, leadership_responses, worker_managers, workers
- **Escribe (2):** **leadership_improvement_actions**, **leadership_improvement_plans**

### `modules/teacher-eval/leadership-reports.html`

- **Módulo:** teacher-eval
- **Lee (12):** leadership_attributes, leadership_behaviors, leadership_cycle_evaluatees, leadership_cycle_evaluators, leadership_cycles, leadership_dimensions, leadership_grades, leadership_interest_groups, leadership_observations, leadership_questions, leadership_responses, workers
- **Escribe (0):** —

### `modules/teacher-eval/leadership-survey.html`

- **Módulo:** teacher-eval
- **Lee (13):** leadership_attributes, leadership_behaviors, leadership_cycle_evaluatees, leadership_cycle_evaluators, leadership_cycles, leadership_dimensions, leadership_grades, leadership_interest_groups, leadership_observations, leadership_question_groups, leadership_questions, leadership_responses, workers
...
- **Módulo:** teacher-eval
- **Lee (8):** academic_years, sections, teval_form_questions, teval_form_sections, teval_periods, teval_responses, teval_sessions, workers
- **Escribe (0):** —
...
- **Módulo:** training
- **Lee (9):** academic_years, permissions, role_permissions, roles, training_facilitators, training_modules, user_roles, users, worker_training_paths
- **Escribe (0):** —
...
- **Módulo:** training
- **Lee (7):** organizational_areas, training_axes, training_facilitators, training_module_facilitators, training_modules, worker_training_paths, workers
...
- **Módulo:** tte
- **Lee (5):** academic_years, tte_categories, tte_priorities, tte_request_fragments, tte_requests
- **Escribe (0):** —

### `modules/tte/index.html`

- **Módulo:** tte
- **Lee (7):** academic_years, permissions, role_permissions, roles, tte_requests, user_roles, users
- **Escribe (0):** —
