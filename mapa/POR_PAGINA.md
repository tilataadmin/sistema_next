...
- **Módulo:** teacher-eval
- **Lee (4):** academic_years, teval_dn_cycles, teval_rubric_domains, teval_rubric_levels
- **Escribe (0):** —
- **Funciones (4):** teval_dn_goals_summary, teval_dn_group_by_component, teval_dn_group_by_worker, teval_dn_trend
