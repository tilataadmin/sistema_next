...
**Reemplaza:** v0.7 … v0.12 (todos retirados)
**Estado:** Fases 1–3 completas en DEV. Fase 4 parcial (`form.html` listo; `leads-review.html` en espera). Fases 5, 6 y **7 completas en DEV**. Esquema del Paso 4 replicado en PROD; bucket y variables Vercel en PROD. Ningún HTML del módulo desplegado a PROD todavía.

---

## 0. QUÉ CAMBIA RESPECTO A v0.12
...
## 0-bis. QUÉ CAMBIÓ EN v0.12 (histórico)
...
- Los contadores tipo "Documentos (3 de 7)" siguen pendientes (leyenda fija por ahora).
